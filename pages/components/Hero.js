...
const Hero = () => {
  ...
  function saveResume(){
    ...
    doc.addImage('https://i.ibb.co/9pq8XZj/PWAMORENO-ALLI-MBI-CV.png', 'PNG', 0, 0, 489.341, 692)
    doc.save('Pwamoreno-resume.pdf')
  }
  ...
  return (
    <div className='flex flex-col md:flex-row justify-between' id='home'>
      <div className='md:pl-20 px-10 xl:pt-[10rem] md:pt-[3rem] pt-12'>
        ...
        <button className='py-4 md:block mr-[31px] border-[3px] text-secondary-color hover:border-tertiary-color font-poppins font-bold px-5 md:py-1 py-2 sm: py-1 rounded-full' onClick={() => saveResume()}>
          Download My Resume
        </button>
      </div>
